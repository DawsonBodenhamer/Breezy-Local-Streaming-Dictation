...
def _pid_exists(pid: int) -> bool:
    """Return whether *pid* exists without sending a signal on Windows."""
...
pre_speech_ms = 256                   # Audio retained before speech detection (ms)
...
def cmd_config(args: argparse.Namespace) -> None:
    ...
    print(f"  pre_speech   = {config.vad.pre_speech_ms}ms")
    print()
    print("[audio]")
